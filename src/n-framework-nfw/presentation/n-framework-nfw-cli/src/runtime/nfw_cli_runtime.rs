...
use crate::commands::r#gen::crud::handler::GenCrudCliCommand;
use crate::commands::r#gen::endpoint::handler::GenEndpointCliCommand;
...
pub fn build_nfw_cli_runtime(services: CliServiceCollection) -> CliRuntime<CliServiceCollection> {
    ...
    ClapCliRuntimeBuilder::new(build_nfw_cli_app_config(), services)
        ...
        .register_handler("gen/crud", GenCrudCliCommand::handle)
        .register_handler("gen/endpoint", GenEndpointCliCommand::handle)
