...
fn parses_valid_yaml() {
    let parser = GeneratorCatalogParser::new(TestYamlParser, TestValidator, TestVersionComparator);
...
id: web-api
name: Web API
description: Production-ready web API generator
version: 1.2.3
language: rust
tags:
  - api
...
source_url: https://github.com/n-framework/generators.git
"#,
        )
...
fn rejects_invalid_yaml() {
    ...
    let result = parser.parse_generator_metadata("id: [");
...
fn rejects_missing_required_fields() {
    ...
    let result = parser.parse_generator_metadata(
        r#"
id: web-api
name: ""
description: ""
...
description: Minimal starter workspace generator
version: 1.0.0
"#,
        )
        .expect("metadata should parse");
