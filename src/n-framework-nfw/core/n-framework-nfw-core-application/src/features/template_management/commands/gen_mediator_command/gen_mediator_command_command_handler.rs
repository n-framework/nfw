...
use super::gen_mediator_command_command::GenMediatorCommandCommand;

#[derive(Debug, Clone)]
pub struct GenMediatorCommandCommandHandler<W, R, E> {
    service: ArtifactGenerationService<W, R, E>,
}

impl<W, R, E> GenMediatorCommandCommandHandler<W, R, E>
where
    ...
    E: TemplateEngine,
{
    ...
    pub fn handle(&self, command: &GenMediatorCommandCommand) -> Result<(), AddArtifactError> {
