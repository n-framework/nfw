    ...
    E: TemplateEngine,
{
    ...
    pub fn handle(&self, command: GenEndpointCommand) -> Result<String, AddArtifactError> {
        ...
        // destination from the endpoint template step.
    ...
    /// reading the mediator source generator types declared in the endpoint template config and
    /// probing each one's step destinations — no hardcoded paths or generator type names.
    fn mediator_artifact_exists(
        &self,
        workspace_context: &crate::features::template_management::services::artifact_generation_service::WorkspaceContext,
        service: &crate::features::template_management::services::artifact_generation_service::ServiceInfo,
        feature_name: &str,
        artifact_name: &str,
    ...
    /// endpoint template's step destination pattern instead of a hardcoded path.
    ...
    pub fn get_workspace_context(&self) -> Result<crate::features::template_management::services::artifact_generation_service::WorkspaceContext, AddArtifactError>{
    ...
    /// search directory and file suffix from the template step destinations — no hardcoded paths.
    ...
    pub fn extract_services(
        &self,
        workspace_context: &crate::features::template_management::services::artifact_generation_service::WorkspaceContext,
    ) -> Result<Vec<crate::features::template_management::services::artifact_generation_service::ServiceInfo>, AddArtifactError>{
    ...
    pub fn load_template_context(
        ...
        self.service
            .load_template_context(workspace_context.clone(), service, template_id)
    }
    ...
    /// loading each source generator's template config and checking whether the service satisfies
    ...
    pub fn has_mediator_sources(
        ...
        for generator_type in mediator_sources {
            if let Ok(ctx) = self.service.load_template_context(
