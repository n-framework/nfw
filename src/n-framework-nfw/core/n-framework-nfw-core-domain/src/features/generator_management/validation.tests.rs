...
fn test_valid_kebab_case() {
    ...
    assert!(is_kebab_case("my-generator"));
    assert!(is_kebab_case("my-generator-123"));
...
fn test_invalid_characters() {
    ...
    assert!(!is_kebab_case("invalid@generator"));
}
...
fn test_numbers_valid() {
    ...
    assert!(is_kebab_case("generator-123"));
    assert!(is_kebab_case("123-generator"));
}
