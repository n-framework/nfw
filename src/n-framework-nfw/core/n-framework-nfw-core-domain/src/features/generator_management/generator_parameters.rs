...
/// A type-safe container for generator parameters used during rendering.
...
/// injection attacks where malicious keys could manipulate generator logic.
...
impl GeneratorParameters {
    ...
    /// Creates a new, empty set of generator parameters.
    pub fn new() -> Self {
        Self::default()
    }
...
impl TryFrom<BTreeMap<String, String>> for GeneratorParameters {
    type Error = String;
...
impl TryFrom<BTreeMap<String, Value>> for GeneratorParameters {
    type Error = String;
...
impl TryFrom<serde_json::Value> for GeneratorParameters {
    type Error = String;
    ...
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        match value {
            ...
            _ => Err("GeneratorParameters must be constructed from a JSON object".to_string()),
        }
    }
}

#[cfg(test)]
#[path = "generator_parameters.tests.rs"]
mod tests;
