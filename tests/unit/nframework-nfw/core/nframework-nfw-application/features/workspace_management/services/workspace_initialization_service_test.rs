...
use nframework_nfw_core_application::features::workspace_management::services::workspace_initialization_service::WorkspaceInitializationService;
...
impl WorkspaceWriter for TestWorkspaceWriter {
    fn write_workspace(
        ...
        _resolution: &nframework_nfw_core_application::features::workspace_management::models::new_command_resolution::NewCommandResolution,
    ) -> Result<(), String> {
        Ok(())
    }
}
