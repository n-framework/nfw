...
impl WorkspaceWriter for TestWorkspaceWriter {
    fn write_workspace(
        ...
        _resolution: &nframework_nfw_application::features::workspace_management::models::new_command_resolution::NewCommandResolution,
    ) -> Result<(), String> {
        Ok(())
    }
}
...
mod tests {
    ...
    fn test_workspace_initialization_service_with_valid_request() {
        ...
        let service = WorkspaceInitializationService::new(
            TestPromptService,
            TestValidator,
            TemplateSelectionForNewService::new(TestCatalogDiscoveryService),
            TestWorkspaceWriter,
