use n_framework_nfw_core_application::features::check::models::CheckLayer;
...
fn architecture_layer_from_path_core_compound_names() {
    assert_eq!(
        CheckLayer::from_path("src/n-framework-nfw-core-domain/Cargo.toml"),
        CheckLayer::Domain
    );
    assert_eq!(
        CheckLayer::from_path("src/n-framework-nfw-core-application/Cargo.toml"),
        CheckLayer::Application
    );
    assert_eq!(
