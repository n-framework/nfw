...
"#,
    ...
    // Scaffold the entity sub-generator so find_artifact_in_features can derive the path.
...
"#,
    ...
    .expect("failed to write entity generator.yaml");
    fs::write(
        entity_tpl_dir.join("content/Entity.cs.tera"),
        "public class {{ Name }} {}",
    )
    .expect("failed to write entity generator");
