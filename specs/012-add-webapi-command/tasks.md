...
- [x] T005 [P] Create application command payload in `src/nfw/src/n-framework-nfw/core/n-framework-nfw-core-application/src/features/generator_management/commands/add_webapi/add_webapi_command.rs`
- [x] T006 [P] Create application command module in `src/nfw/src/n-framework-nfw/core/n-framework-nfw-core-application/src/features/generator_management/commands/add_webapi/mod.rs`

## Phase 2: Foundational

**Goal**: Define generator files and core handler skeletons.

- [x] T007 [P] Create Minimal API startup and route registration extension generators in `src/nfw-generators/src/dotnet-service/webapi/`
- [x] T008 [P] Create CORS/ProblemDetails middleware generators in `src/nfw-generators/src/dotnet-service/webapi/`
- [x] T009 [P] Create OpenAPI/Swagger generators in `src/nfw-generators/src/dotnet-service/webapi/`
- [x] T010 [P] Create HealthCheck endpoint generators in `src/nfw-generators/src/dotnet-service/webapi/`
- [x] T011 [P] Register `webapi` generator in `src/nfw-generators/src/dotnet-service/nfw.generator.yaml`
...
**Independent Test**: Run `nfw add webapi --service <Name> --no-input` and verify generators are copied and `nfw.yaml` is updated correctly.

- [x] T012 [US2] Implement generator rendering logic in `src/nfw/src/n-framework-nfw/core/n-framework-nfw-core-application/src/features/generator_management/commands/add_webapi/add_webapi_command_handler.rs`
- [x] T013 [US2] Implement `nfw.yaml` comment-preserving update logic in `src/nfw/src/n-framework-nfw/core/n-framework-nfw-core-application/src/features/generator_management/commands/add_webapi/add_webapi_command_handler.rs`
...
**Goal**: Guarantee workspace integrity if generator rendering or configuration updates fail.
**Independent Test**: Force a failure (e.g., missing generator) and verify no dangling files or modified configurations are left behind.

- [x] T018 [US3] Implement `GenerationTransaction` file tracking in `src/nfw/src/n-framework-nfw/core/n-framework-nfw-core-application/src/features/generator_management/commands/add_webapi/add_webapi_command_handler.rs`
- [x] T019 [US3] Implement configuration backup and restore logic on error in `src/nfw/src/n-framework-nfw/core/n-framework-nfw-core-application/src/features/generator_management/commands/add_webapi/add_webapi_command_handler.rs`
